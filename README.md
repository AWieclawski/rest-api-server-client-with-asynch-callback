...
The client and server share the same secret key and algorithm: AES/GCM/NoPadding. 1. The Client sends an encrypted Order as a Body with the encrypted password and Client ID in the Headers.
