...
@Slf4j
@Component(CryptoService.BEAN_NAME)
class CryptoService {

    public final static String BEAN_NAME = "edu.orders.client.crypto.CryptoService";
    ...
    String decryptInput(HttpHeaders headers, String input) {
        ...
        try {
            ...
            log.error("Encrypt authorisation error! class: {} message: {} ", ex.getClass(), ex.getMessage(), ex.getCause());
        }
        return null;
    }
    ...
    String decryptAuthorisation(CryptoHeadersDto headersDto) {
        try {
            ...
            log.error("Decrypt authorisation error! class: {} message: {} ", ex.getClass(), ex.getMessage(), ex.getCause());
        }
        return null;
    }
    ...
    private CryptoHeadersDto getCryptoHeadersDto(HttpHeaders headers) {
        try {
            ...
            log.error("CryptoHeadersDto building failed! class: {} message: {} ", ex.getClass(), ex.getMessage(), ex.getCause());
        }
        return null;
    }
